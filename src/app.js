...
const api_version = "v1.0"; //account kit api version
const app_id = ''; // facebook app id
const app_secret = ''; // account kit secret
...
function loadLoginSuccess() {
    return fs.readFileSync('./src/login_success.html').toString();
}
    ...
    if (request.body.csrf_nonce === csrf_guid) {
        ...
        Request.get({url: token_exchange_url, json: true}, function(err, resp, respBody) {
            ...
            var params2 = {
                ...
                appsecret_proof: getHash(respBody.access_token, app_secret)
            };

            // get account details at /me endpoint
            var me_endpoint_url = me_endpoint_base_url + '?' + Querystring.stringify(params2);
